...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerAdd">
            <form action="/billIndex?action=add" method="POST">
                ...
                <div>
                    ...
                    <input type="text" name="billNum" id="billNum" required pattern="(^((\d+\.\d*[1-9]\d{1})|(\d*[1-9]\d*\.\d{2,2}))$)"/>
                    <span>*请输入大于0的正自然数，小数点后保留2位</span>
                </div>
                <div>
                    <label for="money">总金额：</label>
                    <input type="text" name="money" id="money" required pattern="(^((\d+\.\d*[1-9]\d{1})|(\d*[1-9]\d*\.\d{2,2}))$)"/>
                    <span>*请输入大于0的正自然数，小数点后保留2位</span>
                </div>
                <div>
                    <label >供应商：</label>
