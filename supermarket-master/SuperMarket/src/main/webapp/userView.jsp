...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerView">
            <p><strong>用户编号：</strong><span>${user.user_number }</span></p>
            <p><strong>用户名称：</strong><span>${user.user_name }</span></p>
            <p><strong>用户性别：</strong><span>${user.user_sex }</span></p>
            <p><strong>出生日期：</strong><span>${user.user_birth }</span></p>
            <p><strong>用户电话：</strong><span>${user.user_phone }</span></p>
            <p><strong>用户地址：</strong><span>${user.user_address }</span></p>
            <p><strong>用户类别：</strong><span>${user.user_type }</span></p>

            <a href="/userIndex?action=list">返回</a>
        </div>
    </div>
</section>
<footer class="footer">
