    ...
    <div class="left">
        ...
        <nav>
            <ul class="list">
                ...
                <li><a href="/SuperMarket?action=out">密码修改</a></li>
            </ul>
        </nav>
    </div>
    <div class="right">
        ...
        <div class="providerAdd">
            <form action="/supplierIndex?action=add" method="POST">
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" required pattern="((1[3,5,8][0-9])|(14[5,7])|(17[0,6,7,8])|(19[7]))\d{8}$"/>
                    <span>*请输入联系电话</span>
                </div>
                <div>
