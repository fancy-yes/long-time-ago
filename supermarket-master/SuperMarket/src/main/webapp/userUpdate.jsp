...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerAdd">
            <form action="/userIndex?action=update&user_number=${user.user_number }" method="post">
                ...
                <div>
                    ...
                    <input type="text" name="data" id="data" placeholder="${user.user_birth }"/>
                    <span >*</span>
                </div>
                <div>
                    <label for="userphone">用户电话：</label>
                    <input type="text" name="userphone" id="userphone" placeholder="${user.user_phone }"/>
                    <span >*</span>
                </div>
                <div>
                    <label for="userAddress">用户地址：</label>
                    <input type="text" name="userAddress" id="userAddress" placeholder="${user.user_address }"/>
                </div>
                <div>
                    <label >用户类别：</label>
